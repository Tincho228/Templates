<div class="container-fluid pt-5 pb-5 bg-skyblue-middle text-light">
    ...
    <div class="footer-contact">
        ...
        <p ><i class="fas fa-check-circle"></i> Abierto de Lunes a Viernes de 8 a 18hs</p>
    </div>
    <p class="mt-5 mb-3 h5">Redes Sociales</p>
    <div class="footer-links">
        <i class="fab fa-instagram h1" style="margin-right:10px;"></i>
        <i class="fab fa-facebook-f h1" style="margin-right:10px;"></i>
        <i class="fab fa-whatsapp h1"></i>
    </div>
